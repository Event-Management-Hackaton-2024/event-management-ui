...
export const dummyEventData = [
  {
    ...
    visitorsArray: ["Sherri ", "Sam", "Tom", "Anna", "John", "Tink"],
    interests: ["Springboot", "Java", "Maven", "Spring Security"],
  },
  {
    date: "2024-04-21",
    title: "Event 2",
  ...
  {
    date: "2024-05-21",
    title: "Умението да комуникираш, ключ към успеха",
    description:
